describe("Sizer",function() {
  ...
  it("resizes a wide object",function() {
    ...
    var sizeToFit = Sizer.sizeFunction(maxWidth,maxHeight,initialFontSize);

    sizeToFit(object);

    expect(object.width()).toBeLessThan(maxWidth);
    expect(object.height()).toBeLessThan(maxHeight);
