...
== conman - Bootstrap, generate, and manage your conman presentation
...
==== init dir_name
Create a new conman presentation
...
==== update [dir_name]
Update an existing slideshow with the latest Conman JS/CSS files
